...
function SupportApp({ qrToken }: { qrToken: string }) {
  ...
  const [input, setInput] = useState(''); const [attachment, setAttachment] = useState<File | null>(null); const [messages, setMessages] = useState<{ id: string; content: string; errorCode?: string }[]>([]); const [notice, setNotice] = useState('正在识别设备…');

...
public class ProductController {
    ...
    public View create(@Valid @RequestBody Create r) {
        var saved = products.create(current.tenantId(), r.family(), r.model(), r.displayName(), r.region(), r.hardwareVersion(), r.firmwareMin(), r.firmwareMax());
    ...
    public View update(@PathVariable UUID id, @Valid @RequestBody Create request) {
        return View.of(products.update(current.tenantId(), id, request.family(), request.model(), request.displayName(), request.region(), request.hardwareVersion(), request.firmwareMin(), request.firmwareMax()));
    }
    ...
    record FirmwareView(UUID id, String version, String status) {
        static FirmwareView of(FirmwareVersion value) { return new FirmwareView(value.id(), value.version(), value.status().name()); }
    }
}

...
public class IntentClassifier {
 public Intent classify(String text){
  ...
  if(contains(value,"fire","smoke","burn","shock","电击","起火","冒烟","燃烧")) return Intent.SAFETY_RISK;
 ...
 private boolean contains(String value,String... words){for(String word:words)if(value.contains(word))return true;return false;}
}

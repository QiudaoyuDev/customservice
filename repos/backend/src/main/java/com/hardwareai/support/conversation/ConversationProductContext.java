...
@Entity @Table(name="conversation_product_contexts") class ConversationProductContext {
 @Id private UUID id; @Column(name="conversation_id") private UUID conversationId; @Column(name="product_model_id") private UUID productModelId;
